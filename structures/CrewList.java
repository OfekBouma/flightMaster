...
public class CrewList {
    ...
    public void listAllCrewMembers() {
        ...
        while (current != null) {
            CrewMember cm = current.data;

            if (cm instanceof Pilot) {
                Pilot pilot = (Pilot) cm;
                System.out.println("Pilot - Name: " + pilot.getName() +
                                   ", ID: " + pilot.getId() +
                                   ", Employee ID: " + pilot.getEmployeeId() +
                                   ", License: " + pilot.getLicenseNumber() +
                                   ", Rating: " + pilot.getFlightRating());
            } else {
                System.out.println("Crew - Name: " + cm.getName() +
                                   ", ID: " + cm.getId() +
                                   ", Employee ID: " + cm.getEmployeeId() +
                                   ", Role: " + cm.getRole());
            }
